  ...
  return (
    <div className="  flex flex-col justify-start items-center p-2  ">
      <Link
        ...
        className="flex flex-col w-48 h-72  hover:cursor-pointer p-2 bg-white hover:border-red-500 border rounded-md mb-2"
      >
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        />
        <button
          className=" bg-slate-400 rounded-sm w-5 h-5 text-center flex justify-center items-center hover:bg-slate-200 active:bg-slate-300"
      ...
      <button
        className=" bg-green-300 pl-3 pr-3 pt-2 pb-2 m-2 rounded-md hover:bg-green-400 active:bg-green-500"
        onClick={() => {
